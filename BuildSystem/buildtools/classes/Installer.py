...
class Installer:
  ...
  def start(self):
    ...
    file.write('Name: "{group}\\Casal2 user manual"; Filename: "{app}\Casal2_Age.pdf"; WorkingDir: {app}\n')
    file.write('Name: "{group}\\Casal2 user manual"; Filename: "{app}\Casal2_Length.pdf"; WorkingDir: {app}\n')
