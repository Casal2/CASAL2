...
class Installer:
  ...
  def start(self):
    ...
    file.write('// WARNING: THIS FILE IS AUTOMATICALLY GENERATED BY doBuild version. DO NOT EDIT THIS FILE\n')
    file.write('//\n')
    file.write('[Setup]\n')
    ...
    # And remaining files
    file.write('Source: "Casal2\\Casal2_Age.pdf"; DestDir: "{app}"; Flags: ignoreversion\n')
    file.write('Source: "Casal2\\Casal2_Length.pdf"; DestDir: "{app}"; Flags: ignoreversion\n')
    file.write('Source: "Casal2\\Casal2_Contributors_Guide.pdf"; DestDir: "{app}"; Flags: ignoreversion\n')
    ...
    file.write('Name: "{group}\\Casal2 User Manual (age)"; Filename: "{app}\Casal2_Age.pdf"; WorkingDir: {app}\n')
    file.write('Name: "{group}\\Casal2 User Manual (length)"; Filename: "{app}\Casal2_Length.pdf"; WorkingDir: {app}\n')
    file.write('Name: "{group}\\Casal2 Contributors Guide"; Filename: "{app}\Casal2_Contributors_Guide.pdf"; WorkingDir: {app}\n')
