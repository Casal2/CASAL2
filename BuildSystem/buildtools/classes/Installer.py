...
class Installer:
  ...
  def start(self, skip_building = 'false'):
    ...
    file.write('Source: "Casal2\\TestCases\\casal.exe"; DestDir: "{app}\\TestCases"; Flags: replacesameversion recursesubdirs\n')
    file.write('Source: "Casal2\\TestCases\\casal"; DestDir: "{app}\\TestCases"; Flags: replacesameversion recursesubdirs\n')
    file.write('Source: "Casal2\\TestCases\\casalv230-2012-03-21.pdf"; DestDir: "{app}\\TestCases"; Flags: replacesameversion recursesubdirs\n')
    file.write('Source: "Casal2\\TestCases\\primary\\*"; DestDir: "{app}\\TestCases\\primary"; Flags: replacesameversion recursesubdirs\n')
    file.write('[Registry]\n')
    ...
    file.write('Name: "{group}\\CASAL2 user manual"; Filename: "{app}\\Casal2 User Manual.pdf"; WorkingDir: {app}\n')
    ...
    print("-- Writing Installer File")
    if not os.path.exists("bin\\windows\\installer"):
      os.makedirs("bin\\windows\\installer")
    os.system('"C:\\Program Files (x86)\\Inno Setup 6\\ISCC.exe" /Obin\\windows\\installer\\ config.iss')
