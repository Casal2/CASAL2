...
class Installer:
  ...
  def start(self):
    ...
    file.write('  begin \n') 
    file.write('    V := MsgBox(ExpandConstant(\'Hey! An old version of app was detected. Do you want to uninstall it?\'), mbInformation, MB_YESNO); //Custom Message if App installed\n') 
