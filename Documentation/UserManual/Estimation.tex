...
An auto-differentiable minimiser for non-linear models using the mumps solver, see
{\small{\begin{verbatim}
		@minimiser CPPAD
		type cppad
		\end{verbatim}}}
...
\begin{enumerate}
	...
	\\\\
	\item{Beta\index{Beta prior}\index{Priors ! Beta} with mean $\mu$ and standard deviation $\sigma$, and range parameters $A$ and $B$, for parameter value = $p$}
