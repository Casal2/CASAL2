...
\defSub{years}{The years that individual categories will be activated (if different from the model for these categories)}
\defSub{age\_lengths}{The age-length relationship labels for each category}
\defSub{age\_weight}{The age-weight relationships labelsfor each category}
...
\defSub{alpha}{The alpha (maximum value of the selectivity) parameter}
