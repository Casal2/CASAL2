...
\par\textbf{\commandlabsubarg{additional\_\_prior}{type}{ratio}}\par
...
\par\textbf{\commandlabsubarg{penalty}{type}{normal}}\par
...
\defSub{recruitment\_deviation\_penalty} {The label for the recruitment penalty term when using recruitment devs parameterisation for the recruitent process. If estimating recruitment devs and applying this penalty make sure estimates are type = uniform}
\defSub{b0\_intialisation\_phase} {Initialisation phase Label that b0 is from}
