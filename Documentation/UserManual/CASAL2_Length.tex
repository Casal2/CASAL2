...
\newcommand{\ManualRef}{\authors\ (\DocYear). \CNAME\ user manual for length-based models, \VER. \Organisation\ \emph{NIWA Technical Report 139}. \ref{TotPages} p.} % full document reference
...
\begin{titlepage}
  \thispagestyle{empty} % no header/footer/page number on this page
	\begin{center}
		...
		\vspace{1.0cm}
		User manual for length-based models with \CNAME\ \VER\ 
