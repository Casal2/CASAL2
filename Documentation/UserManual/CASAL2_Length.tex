...
\newcommand{\ManualRef}{\authors\ (\DocYear). \CNAME\ user manual for length-based models, \VER. \Organisation\ \emph{NIWA Technical Report 139}. \ref{TotPages} p. (Using source code from \SourceRepos)} % full document reference
