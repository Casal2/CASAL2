...
\defSub{include\_in\_mortality\_block}{Is this process included in the mortality block. This will effect derived quantities and observations that interpolate over the mortality block.}
\defType{Boolean}
\defDefault{false}
\defValue{}
