...
\commandlabsubarg{parameter\_transformation}{type}{difference}.
\label{syntax:Transformation-Difference} \\ \\
The addressable parameters for this transformation are \subcommand{parameter} and \subcommand{difference}. See Section \ref{subsec:Transformation-types}, paragraph \ref{sec:Transformation-Difference}.
