...
\defSub{table methods}{The table of data specifying which fishery interacts with which category, selectivities, and time-step for each fishery and annual duration of the fishery.}
\defDefault{No default}
\defValue{}
\defNote{See below for example}
\begin{verbatim}
...
Fishery1_label  male   	 fish_sel 		1				step1 		
Fishery2_label  male   	 fish_sel 		1 				step1 		
end_table
\end{verbatim}
...
\defSub{table methods}{The table of data specifying which fishery interacts with which category, selectivities, time-step, penalties and \(u_{max}\) for each fishery and year.}
\defDefault{No default}
\defValue{}
\defNote{See below for example}
\begin{verbatim}
