...
\defSub{table methods}{The table of data specifying which fishery interacts with which category, selectivities, penalty, and time-step for each fishery and annual duration of the fishery.}
\defDefault{No default}
\defValue{}
\defNote{See below for example}
\begin{verbatim}
