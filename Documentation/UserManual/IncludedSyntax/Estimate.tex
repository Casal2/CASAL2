...
\defSub{prior\_applies\_to\_transform}{Does the prior apply to the transformed parameter?}
\defType{Boolean}
\defDefault{false}
...
\subsubsection{Estimate of prior type Normal\_By\_Stdev}
...
\subsubsection{Estimate of prior type Normal\_Log}
