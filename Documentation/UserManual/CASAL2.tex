...
\usepackage[bookmarks=true,bookmarksopen=false,bookmarksnumbered=true,
            ...
            pdftitle={Casal2 Technical User Manual}, 
            pdfauthor={S. Rasmussen, I. Doonan, A. Dunn, K. Large, C. Marsh, S. Mormede} %authors
...
\newcommand{\authors}{S. Rasmussen, I. Doonan, A. Dunn, C. Marsh, K. Large, S. Mormede}
\newcommand{\email}{casal2@niwa.co.nz}
\newcommand{\github}{\url{https://github.com/NIWAFisheriesModelling/CASAL2}}
\newcommand{\authorlink}{\href{mailto:"Casal2 Development Team"<casal@niwa.co.nz>?subject=Casal2:}{authors}} 
%hyper ref for email
\newcommand{\Organisation}{National Institute of Water \& Atmospheric Research Ltd.} %%NIWA
\newcommand{\ManualRef}{\authors\ (\DocYear). \CNAME\ Technical User Manual, \VER. \Organisation\ \emph{NIWA Technical Report 139}. \ref{TotPages} p.} % full document reference
...
% Title page
\pdfbookmark[1]{CASAL2 Technical User Manual}{title}
...
\begin{titlepage}
  \thispagestyle{empty} % no header/footer/page number on this page
	\begin{center}
		...
		\vspace*{2.5cm}
		\Huge \CNAME\ Technical User Manual \\
		...
		\vspace{1.0cm}
		\CNAME\ Technical User Manual (modified \DocVer) for use with \cname\texttt{-\VER}
