...
\defRef{sec:Report-Profile}
\label{syntax:Report-Profile}

The Profile type has no additional subcommands.
...
\defSub{length\_values}{Length values to evaluate the a length-based selectivity in an age based model.}
\defType{Vector of real numbers}
\defDefault{true}

\subsubsection{Report of type Selectivity\_By\_Year}
