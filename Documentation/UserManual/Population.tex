...
beta      2              # minimum age selected, so that individuals with age < beta have selectivity = 0
...
The logistic selectivity has estimable parameters $a_{50}$ and $a_{to95}$. $\alpha$ is a scaling parameter, with default value of $\alpha = 1$. $\beta$ is the minimum age to which the selectivity applies. 
