...
$$N_{l,j} = \sum_{a = 1}N_{a,l,j} * S_{a,j}$$
...
$$\widetilde{N_{a,j}}  = \widetilde{N_{a,j}}  +  N_{a,l} * u_l$$

Release mortality denoted by \(U_a\) can be applied before the process finished,
