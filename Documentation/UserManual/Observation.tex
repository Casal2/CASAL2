\section{The observation section: observations and their likelihoods\label{sec:Observations}}

The command and subcommand syntax for the estimation section is given in Section \ref{syntax:Observations}.
...
\subsubsection*{The Dirichlet likelihood\index{Dirichlet likelihood}}\label{sec:Likelihood-Dirichlet}
