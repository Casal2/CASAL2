...
If you estimate \(\theta\) it is recommended to put a transformation on it such as log (see below for example syntax). This likelihood is quite different to configure relative to others because it has an estimable parameter you need to define a \command{likelihood} block for this likelihood.
{\small{\begin{verbatim}
