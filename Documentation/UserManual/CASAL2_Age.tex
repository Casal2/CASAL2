...
\newcommand{\emaillink}{\href{mailto:"Scott Rasmussen"<scott@zaita.com>?subject=Casal2:}{\texttt{Casal2 Development Team}}}
\newcommand{\github}{\url{https://github.com/Casa2/CASAL2}}
...
\newcommand{\ManualRef}{\authors\ (\DocYear). \CNAME\ user manual for age-based models, \VER. \ref{TotPages} p. (Using source code from \SourceRepos)} % full document reference
