...
\usepackage[bookmarks=true,bookmarksopen=false,bookmarksnumbered=true,
            ...
            pdftitle={Getting started with CASAL2}, 
            pdfauthor={C. Marsh} %authors
            pdfsubject={Getting started with Casal2},
            pdftex]{hyperref}
\hypersetup{
...
\newcommand{\ManualRef}{\authors\ (\DocYear). Getting started with \CNAME\. \Organisation. \ref{TotPages} p.} % full document reference
...
% Title page
\pdfbookmark[1]{Getting started with CASAL2}{title}
...
\begin{titlepage}
  \thispagestyle{empty} % no header/footer/page number on this page
	\begin{center}
		...
		\begin{figure}[htp]
			%\begin{left}
			 \includegraphics[height=2.5cm]{../../Manual/Figures/CASAL2.png}
			%\end{left}
		\end{figure}

		\vspace*{2.5cm}
		\Huge Getting started with \CNAME \\
