...
\item \texttt{doBuild unittests} Then enter the directory where this executable lives e.g. \text{BuildSystem\ bin\ windows\ test}, and run the casal2 executable to check all the unit-tests pass.
