...
\CH
Each command-block either consists of a single command (starting with the symbol \command{}) and, for most commands, a label or an argument. Each command is then followed by its subcommands and their arguments, e.g., 
