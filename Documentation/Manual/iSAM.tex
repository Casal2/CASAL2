...
\usepackage[bookmarks=true,bookmarksopen=false,bookmarksnumbered=true,
            ...
            pdftitle={C++ algorithmic stock assessment laboratory 2 (CASAL2) Users Manual}, %title to be confimed
...
\newcommand{\iSAM}{\texttt{CASAL2}} % SAM short name
\newcommand{\isam}{\texttt{casal2}} % sam prefix/suffix
\newcommand{\iSAMName}{C++ Algorithmic Stock Assessment Laboratory} %SAM long name
