...
\subsection{Guidelines for reporting a problem with \CAS\label{sec:error-guidelines}}

\begin{enumerate}
\item Detail the version of \CAS\ are you using? e.g., ``\CAS\ \VER Microsoft Windows executable''
