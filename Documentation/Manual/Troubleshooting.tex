...
\subsection{Guidelines for reporting a problem with \iSAM\label{sec:error-guidelines}}

\begin{enumerate}
\item Detail the version of \iSAM\ are you using? e.g., ``\iSAM\ \VER Microsoft Windows executable''
