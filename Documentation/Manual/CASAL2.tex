...
\newcommand{\CNAME}{Casal2} % CASAL2 name
...
\begin{titlepage}
  \thispagestyle{empty} % no header/footer/page number on this page
	\begin{center}
		...
		\begin{figure}[htp]
			\begin{center}
			 \includegraphics[height=9cm,width=12cm]{Figures/logo_draft1.png}
			\end{center}
		\end{figure}
...
%need code instead of frog 
$\vcenter{\hbox{\includegraphics[height=1.8cm,width=1.8cm]{Figures/example_QR_code}}}$\\
\end{tabulary}
