...
\newcommand{\SAM}{\texttt{iSAM}} % SAM short name
\newcommand{\sam}{\texttt{isam}} % sam prefix/suffix
\newcommand{\SAMName}{Integrated Stock Assessment Model} %SAM long name
...
\newcommand{\ManualRef}{Dunn A., Doonan I., Rasmussen S., Large, K. (\DocYear) \SAMName\ User Manual, \SAM\ \VER. \Organisation\ \emph{Unpublished report}. \ref{TotPages} p.} % full document reference
