...
class Builder:
  ...
  def start(self):
    ...
    cppadFileName         = 'cppad-20141128.epl'
    cppadShortFileName    = 'cppad-20141128'
    ...
    if os.path.exists(cppadShortFileName):
      os.system('chmod 777 -R ' + cppadShortFileName)
      shutil.rmtree(cppadShortFileName)
    os.system('rm -rf *.tar')
    ...
    if os.path.exists(cppadFileName + '.tgz'):
      os.system('gzip -dk ' + cppadFileName + '.tgz 1> isam_unzip.log 2>&1')
      os.system('tar xvf ' + cppadFileName + '.tar 1> isam_untar.log 2>&1')
