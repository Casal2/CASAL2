...
class Builder:
  ...
  def start(self):    
    ...
    # Build Boost
    print('-- Building Boost - check casal2_build.log for progress - estimated time 5 minutes')
    ...
    os.system('b2.exe --toolset=gcc link=static runtime-link=static threading=multi --with-system --with-program_options --with-thread stage 1> casal2_build.log 2>&1')
