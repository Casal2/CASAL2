 ...
 * for validation later using the .checkInvalidParameters() method.
 *
 * @param name The name of the parameter we're allowing
 */
void ParameterList::registerAllowed(string name) {
  valid_parameters_.push_back(name);
}
