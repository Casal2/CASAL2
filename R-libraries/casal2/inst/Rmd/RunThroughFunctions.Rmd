...
single_run = extract.mpd(file = "Estimate.log", path = fpath)
...
mcmc_chain = as.mcmc(mcmc_out$Data[, !colnames(mcmc_out$Data) %in% c("sample", "jacobians", "step_size", "acceptance_rate", "penalties", "acceptance_rate_since_adapt")])
...
# once this occurs you can use all the Code MCMC code
