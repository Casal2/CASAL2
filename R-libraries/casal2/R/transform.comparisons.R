...
"transform.comparisons" = function(Data) {
  ...
  if (n_categories > 2) {
    stop(paste0("This function can currently only deal with an age composition with 2 unique categories, but we found ", n_categories, " plz check you have selected the correct observation to weight"))
  }
