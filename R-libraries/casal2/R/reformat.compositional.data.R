...
reformat.compositional.data = function(extract_list,comp_label) {
  if (!comp_label %in% names(extract_list)) {
    stop(Paste("could not find '", comp_label, "' report in your extract list. Make sure you have specified the right @report in your report.csl2"))
  }
