#' Calculate the Inverse-Logistic Selectivity used in Casal2
#'
#' This function calculates the Inverse-Logistic selectivity and should be used to plot up the form of the selectivity when estimating the parameters in the model.
#'
#' @author Craig Marsh
