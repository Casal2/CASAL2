...
TEST_F(InternalEmptyModel, EstimateTransformations_SquareRoot) {
  ...
  EXPECT_NEAR(2299.4037476431758, obj_function.score(), 0.0001);  // For some reason linus minimised this to 1977.8957463948109
}
...
TEST_F(InternalEmptyModel, EstimateTransformations_SquareRoot_NoBounds) {
  ...
  ObjectiveFunction& obj_function = model_->objective_function();
  EXPECT_NEAR(2299.4037476431758, obj_function.score(), 1e-5);
}
