...
SquareRoot::SquareRoot(shared_ptr<Model> model) : EstimateTransformation(model) {
  parameters_.Bind<string>(PARAM_ESTIMATE_LABEL, &estimate_label_, "The label of the estimate block to apply transformation. Defined as theta1 in the documentation", "");
}
