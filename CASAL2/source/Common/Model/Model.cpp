...
#include "Common/ConfigurationLoader/EstimableValuesLoader.h"
#include "Common/ConfigurationLoader/MCMCObjective.h"
#include "Common/ConfigurationLoader/MCMCSample.h"
#include "Common/EquationParser/EquationParser.h"
...
Model::Model() {
  ...
  parameters_.Bind<bool>(PARAM_PLUS_GROUP, &plus_group_, "Define the oldest age or extra length midpoint (plus\_group\_size) as a plus group", "true, false", false);
