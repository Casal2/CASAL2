 ...
 */
#ifndef SOURCE_REPORTS_CHILDREN_INITIALISATIONPARTITION_MEANWEIGHT_H_
#define SOURCE_REPORTS_CHILDREN_INITIALISATIONPARTITION_MEANWEIGHT_H_
...
#endif /* SOURCE_REPORTS_CHILDREN_INITIALISATIONPARTITION_MEANWEIGHT_H_ */
