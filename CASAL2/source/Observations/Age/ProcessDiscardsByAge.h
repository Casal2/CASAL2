 ...
 *
 */
#ifndef AGE_OBSERVATIONS_DISCARDS_BY_AGE_H_
#define AGE_OBSERVATIONS_DISCARDS_BY_AGE_H_
 ...
 * Class Definition
 */
class ProcessDiscardsByAge : public niwa::Observation {
public:
  // Methods
  explicit ProcessDiscardsByAge(Model* model);
  virtual                     ~ProcessDiscardsByAge();
...
#endif /* AGE_OBSERVATIONS_DISCARDS_BY_AGE_H_ */
