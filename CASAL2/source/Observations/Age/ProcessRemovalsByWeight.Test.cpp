...
const std::string test_cases_observation_removals_by_weight_for_fishery_single =
R"(
@model
start_year 1990
final_year 1997
 ...
 *
 */
TEST_F(InternalEmptyModel, Observation_removals_by_weight_for_fishery_Single) {
  AddConfigurationLine(test_cases_observation_removals_by_weight_for_fishery_single, __FILE__, 31);
  LoadConfiguration();
