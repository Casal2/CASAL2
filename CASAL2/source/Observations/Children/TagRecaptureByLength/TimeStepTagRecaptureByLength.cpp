/**
 * @file TimeStepTagRecaptureByLength.cpp
 * @author C.Marsh
...
// headers
#include "TimeStepTagRecaptureByLength.h"
 ...
 *
 */
TimeStepTagRecaptureByLength::TimeStepTagRecaptureByLength(Model* model)
  : observations::TagRecaptureByLength(model) {
 ...
 *
 */
void TimeStepTagRecaptureByLength::DoBuild() {
  TagRecaptureByLength::DoBuild();
