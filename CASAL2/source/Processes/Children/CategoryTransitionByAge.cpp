/**
 * @file CategoryTransitionByAge.cpp
...
// headers
#include "CategoryTransitionByAge.h"
 ...
 * Default constructor
 */
CategoryTransitionByAge::CategoryTransitionByAge(Model* model)
  : Process(model),
    to_partition_(model),
 ...
 * Destructor
 */
CategoryTransitionByAge::~CategoryTransitionByAge() {
  delete n_table_;
}
 ...
 */
void CategoryTransitionByAge::DoValidate() {
 ...
 */
void CategoryTransitionByAge::DoBuild() {
 ...
 * Execute the process
 */
void CategoryTransitionByAge::DoExecute() {
