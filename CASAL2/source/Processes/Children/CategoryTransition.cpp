 ...
 * Default Constructor
 */
CategoryTransition::CategoryTransition(Model* model)
  : Process(model),
 ...
 */
void CategoryTransition::DoValidate() {
  LOG_TRACE();
 ...
 */
void CategoryTransition::DoBuild() {
  LOG_TRACE();
 ...
 */
void CategoryTransition::DoExecute() {
 ...
 */
void CategoryTransition::DoReset() {
