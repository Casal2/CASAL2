/**
 * @file CategoryTransitionByYear.cpp
...
// headers
#include "CategoryTransitionByYear.h"
 ...
 * default constructor
 */
CategoryTransitionByYear::CategoryTransitionByYear(Model* model)
  : Process(model),
  ...
  parameters_.Bind<string>(PARAM_SELECTIVITIES, &selectivity_names_, "List of selectivities to use for CategoryTransitionByYear", "");
 ...
 */
void CategoryTransitionByYear::DoValidate() {
 ...
 */
void CategoryTransitionByYear::DoBuild() {
  LOG_TRACE();
...
/**
 * Execute our CategoryTransitionByYear rate process.
 */
void CategoryTransitionByYear::DoExecute() {
