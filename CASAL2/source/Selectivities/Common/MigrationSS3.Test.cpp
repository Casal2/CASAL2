...
TEST(Selectivities, Migration_Age_ss3) {
  ...
  EXPECT_NEAR(0.02000000, migration_stock_synthesis.GetAgeResult(21, nullptr), 1e-4);  
  EXPECT_NEAR(0.02000000, migration_stock_synthesis.GetAgeResult(22, nullptr), 1e-4); 
  EXPECT_NEAR(0.02000000, migration_stock_synthesis.GetAgeResult(23, nullptr), 1e-4); 
  EXPECT_NEAR(0.02000000, migration_stock_synthesis.GetAgeResult(24, nullptr), 1e-4); 
  EXPECT_NEAR(0.02000000, migration_stock_synthesis.GetAgeResult(25, nullptr), 1e-4); 
