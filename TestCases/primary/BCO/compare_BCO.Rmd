...
for (c in 1:num_C2_models)
{
    ...
    print(paste('Actual catches for line match:',
                time_series_match(c1_quant$actual_catches$line, cas2_mpd[[c]]$Mortality$`actual_catch[FishingLine]`)))
    ...
    print(paste('Actual catches for pot match:',
                time_series_match(c1_quant$actual_catches$pot, cas2_mpd[[c]]$Mortality$`actual_catch[FishingPot]`)))
    ...
    print(paste('Actual catches for rec match:',
                time_series_match(c1_quant$actual_catches$rec, cas2_mpd[[c]]$Mortality$`actual_catch[Recreation]`)))
