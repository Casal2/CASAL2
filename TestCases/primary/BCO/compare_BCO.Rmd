...
* Beverton-Holt stock-recruitment relationship, with steepness (h) set to 0.75, $\sigma_R$ set to 0.6
* no ageing error
* one survey with sex-specific logistic selectivity
* three fisheries, all with sex-specific logistic selectivity and retained/discarded catches
...
* male $L_{\infty}$
* male age-length CV2
* sex-specific survey logistic selectivity
...
plot(ages, c1_quant$`Ogive parameter values`$`selectivity[potSsel].male`, type='l', col='black', lwd=5, ylim=c(0,max_val), xlab='Age', ylab='', main='Pot survey selectivity-at-age comparison')
