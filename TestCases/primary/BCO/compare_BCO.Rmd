---
title: "Casal2 Test Case comparisons for BCO"
output:
    html_document:
        toc: TRUE
        toc_depth: 2
...
The CASAL model sensitivity 1 has a smaller tolerance value than the CASAL base model (1e-7 vs. 2e-5).
...
* natural mortality-at-age is 0.17
* sex-specific logistic maturity
* sex-specific von Bertalanffy age-length relationship
* one length-weight relationship ($W = aL^b$)
* Beverton-Holt stock-recruitment relationship, with steepness (h) set to 0.75, sigmaR set to 0.6
* ageing error
* one survey with sex-specific logistic selectivity
* three fisheries, all three with sex-specific logistic selectivity
