...
plot(c1_quant$removals$year, c1_quant$removals$line, type='l', col='black', lwd=5, ylim=c(0, max_val), xlab='Year', ylab='Catch (tonnes)', main='Removals / Actual catch comparison: line')
lines(c1_sens1_quant$removals$year, c1_sens1_quant$removals$line, type='l', col='grey', lwd=2.5)
for (c in 1:num_C2_models)
{
...
plot(c1_quant$removals$year, c1_quant$removals$pot, type='l', col='black', lwd=5, ylim=c(0, max_val), xlab='Year', ylab='Catch (tonnes)', main='Removals / Actual catch comparison: pot')
lines(c1_sens1_quant$removals$year, c1_sens1_quant$removals$pot, type='l', col='grey', lwd=2.5)
for (c in 1:num_C2_models)
{
...
plot(c1_quant$removals$year, c1_quant$removals$rec, type='l', col='black', lwd=5, ylim=c(0, max_val), xlab='Year', ylab='Catch (tonnes)', main='Removals / Actual catch comparison: recreational')
lines(c1_sens1_quant$removals$year, c1_sens1_quant$removals$rec, type='l', col='grey', lwd=2.5)
for (c in 1:num_C2_models)
{
...
plot(c1_quant$discards$year, c1_quant$discards$line, type='l', col='black', lwd=5, ylim=c(0, max_val), xlab='Year', ylab='Catch (tonnes)', main='Discarded catch comparison: line')
lines(c1_sens1_quant$discards$year, c1_sens1_quant$discards$line, type='l', col='grey', lwd=2.5)
for (c in 1:num_C2_models)
{
...
plot(c1_quant$discards$year, c1_quant$discards$pot, type='l', col='black', lwd=5, ylim=c(0, max_val), xlab='Year', ylab='Catch (tonnes)', main='Discarded catch comparison: pot')
lines(c1_sens1_quant$discards$year, c1_sens1_quant$discards$pot, type='l', col='grey', lwd=2.5)
for (c in 1:num_C2_models)
{
...
plot(c1_quant$discards$year, c1_quant$discards$rec, type='l', col='black', lwd=5, ylim=c(0, max_val), xlab='Year', ylab='Catch (tonnes)', main='Discarded catch comparison: recreational')
lines(c1_sens1_quant$discards$year, c1_sens1_quant$discards$rec, type='l', col='grey', lwd=2.5)
for (c in 1:num_C2_models)
{
...
plot(c1_quant$fishing_pressures$year, c1_quant$fishing_pressures$line, type='l', col='black', lwd=5, ylim=c(0, max_val), xlab='Year', ylab='U', main='Fishing pressure comparison: line')
lines(c1_sens1_quant$fishing_pressures$year, c1_sens1_quant$fishing_pressures$line, type='l', col='grey', lwd=2.5)
for (c in 1:num_C2_models)
{
...
plot(c1_quant$fishing_pressures$year, c1_quant$fishing_pressures$pot, type='l', col='black', lwd=5, ylim=c(0, max_val), xlab='Year', ylab='U', main='Fishing pressure comparison: pot')
lines(c1_sens1_quant$fishing_pressures$year, c1_sens1_quant$fishing_pressures$pot, type='l', col='grey', lwd=2.5)
for (c in 1:num_C2_models)
{
...
plot(c1_quant$fishing_pressures$year, c1_quant$fishing_pressures$rec, type='l', col='black', lwd=5, ylim=c(0, max_val), xlab='Year', ylab='U', main='Fishing pressure comparison: recreational')
lines(c1_sens1_quant$fishing_pressures$year, c1_sens1_quant$fishing_pressures$rec, col='grey', lwd=2.5)
for (c in 1:num_C2_models)
{
...
plot(ages, c1_quant$`Ogive parameter values`$`selectivity[potSsel].male`, type='l', col='black', lwd=5, ylim=c(0,max_val), xlab='Age', ylab='', main='Summer survey selectivity-at-age comparison')
lines(ages, c1_quant$`Ogive parameter values`$`selectivity[potSsel].female`, col='black', lwd=5, lty=3)

lines(ages, c1_sens1_quant$`Ogive parameter values`$`selectivity[potSsel].male`, col='grey', lwd=2.5)
lines(ages, c1_sens1_quant$`Ogive parameter values`$`selectivity[potSsel].female`, col='grey', lwd=2.5, lty=3)
