...
* Beverton-Holt stock-recruitment relationship, with steepness (h) set to 0.9, $\sigma_R$ set to 1.0
...
* B0
* process error for the immature and mature survey indices
* the difference between male and female natural mortality
...
for (c in 1:num_C2_models)
{
    ...
    c2_catch <- cas2_mpd[[c]]$Mortality$`actual_catch[Trawl]`

    print(paste('Actual catches for Trawl match:', time_series_match(c1_catch, c2_catch)))
...
plot(ages, cas_part$initial[1,], type='l', col='black', lwd=5, ylim=c(0, max_val), xlab='Age', ylab='', main='Initial numbers-at-age comparison (spawn)')
...
plot(ages, cas_part$initial[3,], type='l', col='black', lwd=5, ylim=c(0, max_val), xlab='Age', ylab='', main='Initial numbers-at-age comparison (nonspawn)')
lines(ages, cas_part$initial[4,], col='black', lwd=5, lty=3)
lines(ages, cas_sens1_part$initial[3,], col='grey', lwd=2.5)
lines(ages, cas_sens1_part$initial[4,], col='grey', lwd=2.5, lty=3)
for (c in 1:num_C2_models)
{
...
plot(ages, cas_part$final[1,], type='l', col='black', lwd=5, ylim=c(0, max_val), xlab='Age', ylab='', main='Final numbers-at-age comparison (spawn; time step 2)')
...
plot(ages, cas_part$final[3,], type='l', col='black', lwd=5, ylim=c(0, max_val), xlab='Age', ylab='', main='Final numbers-at-age comparison (nonspawn; time step 2)')
lines(ages, cas_part$final[4,], col='black', lwd=5, lty=3)
lines(ages, cas_sens1_part$final[3,], col='grey', lwd=2.5)
lines(ages, cas_sens1_part$final[4,], col='grey', lwd=2.5, lty=3)
for (c in 1:num_C2_models)
{
    lines(ages, c2_mat[c,3,], col=C2_color[c], lwd=1)
    lines(ages, c2_mat[c,4,], col=C2_color[c], lwd=1, lty=3)
...
plot(c1_quant$fishing_pressures$year, c1_quant$fishing_pressures$pressure, type='l', col='black', lwd=5, ylim=c(0, max_val), xlab='Year', ylab='U', main='Fishing pressure comparison: Trawl')
...
plot(ages, c1_quant$`Ogive parameter values`$`migration[toSpawn].rates_male`, type='l', col='black', lwd=5, ylim=c(0,max_val), xlab='Age', ylab='', main='Migration rates-at-age (male toSpawn)')

lines(ages, c1_sens1_quant$`Ogive parameter values`$`migration[toSpawn].rates_male`, col='grey', lwd=2.5)
...
plot(ages, c1_quant$`Ogive parameter values`$`migration[toSpawn].rates_female`, type='l', col='black', lwd=5, ylim=c(0,max_val), xlab='Age', ylab='', main='Migration rates-at-age (female toSpawn)')

lines(ages, c1_sens1_quant$`Ogive parameter values`$`migration[toSpawn].rates_female`, col='grey', lwd=2.5)
