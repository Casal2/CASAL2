...
cas_corr <- casal::extract.correlation.matrix(mpd_run, file.path(base_dir, 'CASAL'))
c1_quant <- cas_mpd$quantities

cas_mpd_sens1  <- casal::extract.mpd(mpd_run, file.path(base_dir, 'CASAL_sens1'))
cas_corr_sens1 <- casal::extract.correlation.matrix(mpd_run, file.path(base_dir, 'CASAL_sens1'))
...
for (c in 1:num_C2_models)
{
    ...
    # TODO:  add casal2::extract.covariance.matrix() and casal2::extract.correlation.matrix()
    # cas2_corr[[c]] <- casal2::extract.correlation.matrix()
}
```
...
{
    image(corr_obj, col=hcl.colors(31, 'purple-yellow'), xlab='Parameter', ylab='Parameter', main=label)
...
plot_image_and_range(cas_corr_sens1, 'CASAL sensitivity 1 parameter correlation')
