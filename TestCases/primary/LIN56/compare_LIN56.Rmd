...
get_convergence_information <- function(filename)
{
    ...
    str_vec <- grep('check', grep('converge', readLines(filename), ignore.case=TRUE, value=TRUE), value=TRUE, invert=TRUE)
...
for (c in 1:num_C2_models)
{
    ...
    # cas2_corr[[c]] <- casal2::extract.correlation.matrix(cas2_mpd_filename)
