...
This is an R Markdown document comparing the results of at least 2 CASAL (base and sensitivity) and up to 8 Casal2 (3 BetaDiff, 2 CppAD, and 3 ADOL-C) model configurations.
...
if (!require(casal))
{
    install.packages('../../../R-libraries/casal_2.30.tar.gz', repos=NULL, type='source')
    # install('casal_utils')
}

if (!require(casal2))
{
    install.packages('../../../R-libraries/casal2_1.0.tar.gz', repos=NULL, type='source')
}
