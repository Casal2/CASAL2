...
plot(lengths, c1_quant$`Ogive parameter values`$maturity_props.all, type='l', col='black', lwd=bl_lwd, ylim=c(0,max_val), xlab='Age', ylab='', main='Maturity-at-length comparison')
...
plot(lengths, c1_quant$`Ogive parameter values`$`selectivity[FishingSel_1].male`, type='l', col='black', lwd=bl_lwd, ylim=c(0,max_val), xlab='Age', ylab='', main='Trawl fishery 1 selectivity-at-length comparison', , sub='Dotted lines for female')
...
plot(lengths, c1_quant$`Ogive parameter values`$`selectivity[FishingSel_2].male`, type='l', col='black', lwd=bl_lwd, ylim=c(0,max_val), xlab='Age', ylab='', main='Trawl fishery 2 selectivity-at-length comparison', , sub='Dotted lines for female')
...
plot(lengths, c1_quant$`Ogive parameter values`$`selectivity[TrawlSurveySel_1].male`, type='l', col='black', lwd=bl_lwd, ylim=c(0,max_val), xlab='Age', ylab='', main='Trawl survey 1 selectivity-at-length comparison', , sub='Dotted lines for female')
...
plot(lengths, c1_quant$`Ogive parameter values`$`selectivity[TrawlSurveySel_2].male`, type='l', col='black', lwd=bl_lwd, ylim=c(0,max_val), xlab='Age', ylab='', main='Trawl survey 2 selectivity-at-length comparison', , sub='Dotted lines for female')
