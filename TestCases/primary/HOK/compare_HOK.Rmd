...
plot(c1_quant$SSBs$year, c1_quant$SSBs$E, type='l', col='black', lwd=4, ylim=c(0, max_val), xlab='Year', ylab='Biomass (t)', main='E SSB comparison')
...
plot(c1_quant$SSBs$year, c1_quant$SSBs$W, type='l', col='black', lwd=4, ylim=c(0, max_val), xlab='Year', ylab='Biomass (t)', main='W SSB comparison')
...
for (i in 1:nrow(c2_mat[1,,]))
{
    ...
    plot(seq(1, 17), c1_mat[i,], type='l', col='black', lwd=4, ylim=c(0, max_val), xlab='Year', ylab='', main=paste('Initial numbers-at-age comparison:', cas2_mpd[[1]]$Init$values[i,1]))
...
plot(c1_quant$YCS$E, type='l', col='black', lwd=4, ylim=c(0, max_val), xlab='Year', ylab='', main='E YCS comparison')
...
plot(c1_quant$YCS$W, type='l', col='black', lwd=4, ylim=c(0, max_val), xlab='Year', ylab='', main='W YCS comparison')
...
plot(c1_quant$true_YCS$year, c1_quant$true_YCS$E, type='l', col='black', lwd=4, ylim=c(0, max_val), xlab='Year', ylab='', main='E true YCS comparison')
...
plot(c1_quant$true_YCS$year, c1_quant$true_YCS$W, type='l', col='black', lwd=4, ylim=c(0, max_val), xlab='Year', ylab='', main='W true YCS comparison')
...
plot(c1_quant$recruitments$year, c1_quant$recruitments$E, type='l', col='black', lwd=4, ylim=c(0, max_val), xlab='Year', ylab='', main='E Recruits comparison')
...
plot(c1_quant$recruitments$year, c1_quant$recruitments$W, type='l', col='black', lwd=4, ylim=c(0, max_val), xlab='Year', ylab='', main='W Recruits comparison')
...
plot(names(c1_surv), c1_surv, type='l', col='black', lwd=4, ylim=c(0, max_val), xlab='Year', ylab='Biomass (t)', main='Survey comparison: WCacous')
...
plot(names(c1_surv), c1_surv, type='l', col='black', lwd=4, ylim=c(0, max_val), xlab='Year', ylab='Biomass (t)', main='Survey comparison: CRsumbio')
lines(names(c1_s1_surv), c1_s1_surv, type='l', col='grey', lwd=2.5)
points(c2_surv[[c]]$year, c2_surv[[c]]$observed, pch=20, col='black')
arrows(c2_surv[[c]]$year, (c2_surv[[c]]$observed * exp(-1.96 * c2_surv[[c]]$error_value)), c2_surv[[c]]$year, (c2_surv[[c]]$observed * exp(1.96 * c2_surv[[c]]$error_value)), length=0.05, angle=90, code=3)
for (c in 1:num_C2_models)
...
plot(c1_quant$fishing_pressures$year, c1_quant$fishing_pressures$Ensp1, type='l', col='black', lwd=4, ylim=c(0, max_val), xlab='Year', ylab='U', main='Fishing pressure comparison: Ensp1')
...
plot(c1_quant$fishing_pressures$year, c1_quant$fishing_pressures$Wnsp1, type='l', col='black', lwd=4, ylim=c(0, max_val), xlab='Year', ylab='U', main='Fishing pressure comparison: Wnsp1')
...
plot(c1_quant$fishing_pressures$year, c1_quant$fishing_pressures$Ensp2, type='l', col='black', lwd=4, ylim=c(0, max_val), xlab='Year', ylab='U', main='Fishing pressure comparison: Ensp2')
...
plot(c1_quant$fishing_pressures$year, c1_quant$fishing_pressures$Wnsp2, type='l', col='black', lwd=4, ylim=c(0, max_val), xlab='Year', ylab='U', main='Fishing pressure comparison: Wnsp2')
...
plot(c1_quant$fishing_pressures$year, c1_quant$fishing_pressures$Esp, type='l', col='black', lwd=4, ylim=c(0, max_val), xlab='Year', ylab='U', main='Fishing pressure comparison: Esp')
...
plot(c1_quant$fishing_pressures$year, c1_quant$fishing_pressures$Wsp, type='l', col='black', lwd=4, ylim=c(0, max_val), xlab='Year', ylab='U', main='Fishing pressure comparison: Wsp')
...
plot(ages, c1_quant$`Ogive parameter values`$`selectivity[Enspsl].all`, type='l', col='black', lwd=4, ylim=c(0,max_val), xlab='Age', ylab='', main='Survey selectivity-at-age comparison: Enspsl')
...
plot(ages, c1_quant$`Ogive parameter values`$`selectivity[Wnspsl].all`, type='l', col='black', lwd=4, ylim=c(0,max_val), xlab='Age', ylab='', main='Survey selectivity-at-age comparison: Wnspsl')
...
plot(ages, c1_quant$`Ogive parameter values`$`selectivity[Espsl].all`, type='l', col='black', lwd=4, ylim=c(0,max_val), xlab='Age', ylab='', main='Survey selectivity-at-age comparison: Espsl')
...
plot(ages, c1_quant$`Ogive parameter values`$`selectivity[Wspsl].all`, type='l', col='black', lwd=4, ylim=c(0,max_val), xlab='Age', ylab='', main='Survey selectivity-at-age comparison: Wspsl')
...
plot(ages, c1_quant$`Ogive parameter values`$`selectivity[CRsl].all`, type='l', col='black', lwd=4, ylim=c(0,max_val), xlab='Age', ylab='', main='Survey selectivity-at-age comparison: CRsl')
...
plot(ages, c1_quant$`Ogive parameter values`$`selectivity[SAsl].all`, type='l', col='black', lwd=4, ylim=c(0,max_val), xlab='Age', ylab='', main='Survey selectivity-at-age comparison: SAsl')
