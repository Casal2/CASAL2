...
for (c in 1:num_C2_models)
{
    ...
    print(paste('Actual catches for Ensp1 match:',
                time_series_match(c1_quant$actual_catches$Ensp1, cas2_mpd[[c]]$Mortality$`catch[Ensp1]`)))

    print(paste('Actual catches for Wnsp1 match:',
                time_series_match(c1_quant$actual_catches$Wnsp1, cas2_mpd[[c]]$Mortality$`catch[Wnsp1]`)))

    print(paste('Actual catches for Ensp2 match:',
                time_series_match(c1_quant$actual_catches$Ensp2, cas2_mpd[[c]]$Mortality$`catch[Ensp2]`)))

    print(paste('Actual catches for Wnsp2 match:',
                time_series_match(c1_quant$actual_catches$Wnsp2, cas2_mpd[[c]]$Mortality$`catch[Wnsp2]`)))

    print(paste('Actual catches for Esp match:',
                time_series_match(c1_quant$actual_catches$Esp, cas2_mpd[[c]]$Mortality$`catch[Esp]`)))

    print(paste('Actual catches for Wsp match:',
                time_series_match(c1_quant$actual_catches$Wsp, cas2_mpd[[c]]$Mortality$`catch[Wsp]`)))
...
max_val <- max(c1_quant$SSBs$E,
               ...
               max(unlist(list.map(cas2_mpd, max(DerivedQuantities$SSB_E$values)))))
...
for (c in 1:num_C2_models)
{
    lines(names(cas2_mpd[[c]]$DerivedQuantities$SSB_E$values), cas2_mpd[[c]]$DerivedQuantities$SSB_E$values, col=C2_color[c], lwd=1)
}
...
max_val <- max(c1_quant$SSBs$W,
               ...
               max(unlist(list.map(cas2_mpd, max(DerivedQuantities$SSB_W$values)))))
...
for (c in 1:num_C2_models)
{
    lines(names(cas2_mpd[[c]]$DerivedQuantities$SSB_E$values), cas2_mpd[[c]]$DerivedQuantities$SSB_W$values, col=C2_color[c], lwd=1)
}
...
for (i in 1:nrow(c2_mat[1,,]))
{
    ...
    plot(ages, cas_part$initial[i,], type='l', col='black', lwd=bl_lwd, ylim=c(0, max_val), xlab='Age', ylab='', main=paste('Initial numbers-at-age comparison:', cas2_mpd[[1]]$Init$values[i,1]))
...
for (i in 1:nrow(c2_mat[1,,]))
{
    ...
    plot(ages, cas_part$final[i,], type='l', col='black', lwd=bl_lwd, ylim=c(0, max_val), xlab='Age', ylab='', main=paste('Final numbers-at-age comparison:', cas2_mpd[[1]]$Init$values[i,1]))
...
for (c in 1:num_C2_models)
{
    lines((cas2_mpd[[c]]$Recruit_E$ycs_years + cas2_mpd[[c]]$Recruit_E$ssb_offset), cas2_mpd[[c]]$Recruit_E$Recruits, col=C2_color[c], lwd=1)
}
...
for (c in 1:num_C2_models)
{
    lines((cas2_mpd[[c]]$Recruit_W$ycs_years + cas2_mpd[[c]]$Recruit_W$ssb_offset), cas2_mpd[[c]]$Recruit_W$Recruits, col=C2_color[c], lwd=1)
}
