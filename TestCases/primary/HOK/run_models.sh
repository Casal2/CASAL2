...
rm -f params_est.out
../../../../../BuildSystem/bin/_gcc/release_betadiff/casal2 -e -o params_est.out > run_estimation.txt 2>&1
...
# rm -f params_est.out
# ../../../../../BuildSystem/bin/_gcc/release_cppad/casal2 -e -o params_est.out > run_estimation.txt 2>&1
...
rm -f params_est.out
../../../../../BuildSystem/bin/_gcc/release_adolc/casal2 -e -o params_est.out > run_estimation.txt 2>&1
