...
c2_mat <- array(0, dim=c(num_C2_models, dim(as.matrix(cas2_mpd[[1]]$Init$values))))
for (c in 1:num_C2_models)
{
    c2_mat[c,,] <- as.matrix(cas2_mpd[[c]]$Init$values)
}
...
# [37] "CSacous"              "WCacous"              "CRsum"
# [40] "SAsum"                "SAaut"                "SSB_E"
# [43] "SSB_W"                "SAautbio"             "Ageing"
# [46] "Ertn"                 "Wrtn"                 "Whome"
# [49] "Espmg"                "Wspmg"                "sel_Whome"
# [52] "sel_Espmg"            "sel_Wspmg"            "One"
# [55] "Point5"               "messages_encountered"
# > names(cas2_mpd[[1]]$Instant_mortality)
#  [1] "categories"              "label"                   "m"
#  [4] "relative_m_by_age"       "time_step_proportions"   "sub_type"
