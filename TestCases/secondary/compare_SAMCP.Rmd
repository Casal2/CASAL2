...
SSB_pd     <- matrix(0, nrow=num_ds, ncol=num_years)
Rec_pd     <- matrix(0, nrow=num_ds, ncol=num_years)
survey_pd  <- matrix(0, nrow=num_ds, ncol=num_years)
U_pd       <- matrix(0, nrow=num_ds, ncol=num_years)
catch_pd   <- matrix(0, nrow=num_ds, ncol=num_years)
